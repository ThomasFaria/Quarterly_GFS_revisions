...
```{r}
#| label: tbl-rev-chron
#| tbl-cap: Timing of the revisions and underlying releases
 
tbl_img <- data.frame(
  Name = c("")
)
tbl_img |>
  kableExtra::kbl(booktabs = T, col.names = c("")) |>
  kableExtra::kable_paper(full_width = F) |>
  kableExtra::column_spec(1, image = "rev-chron.png") 
```
:::
